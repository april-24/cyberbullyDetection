...
Two ways to choose videos:
  1. SEARCH_QUERIES - the script searches YouTube for videos matching each
     query (restricted to Malaysia) and collects comments from the results.
...
Output: data/crawled/youtube_malaysia_raw.csv (UNLABELED - see README in this folder)
...
# Neutral, topic-based queries tend to naturally surface heated comment
# sections without steering toward any specific target - keep queries broad.
SEARCH_QUERIES = [
    "Malaysia news debate",
    "Malaysia viral video",
    "berita Malaysia terkini",     # Malay: "latest Malaysia news"
    "Malaysia politik",            # Malay: "Malaysia politics"
    "Malaysia drama viral",
]
...
REGION = "MY"                 # bias search results toward Malaysia
OUTPUT_CSV = "data/crawled/youtube_malaysia_raw.csv"
